...
export function initShow({ onEdit, onBan }) {
    ...
    function addRow(user) {
        ...
        const btnBan = row.querySelector(".btn-ban")
        if (user.status === "banned") btnBan.disabled = true
        btnBan.addEventListener("click", () => onBan(user, row))
